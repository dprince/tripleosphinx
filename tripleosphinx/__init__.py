...
def builder_inited(app):
    ...
    app.info('Using tripleo theme from %s' % theme_dir)
    ...
    # another tripleo theme is already selected. This is done here,
    ...
    # Set the theme name
    if not app.config.html_theme.startswith('tripleo'):
        app.config.html_theme = 'tripleo'
